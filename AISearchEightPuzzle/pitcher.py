...
class PitcherState(ProblemState):
    ...
    def illegal(self):
        ...
        """
        if self.q3 < 0 or self.q4 < 0: return True
        if self.q3 > 3 or self.q4 > 4: return True
        return False
...
Search(PitcherState(1,0), PitcherState(0,4))
# InformedSearch(PitcherState(1,0), PitcherState(0,4))
